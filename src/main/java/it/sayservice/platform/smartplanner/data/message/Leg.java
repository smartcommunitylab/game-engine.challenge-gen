...
import it.sayservice.platform.smartplanner.data.message.alerts.*;
...
public class Leg implements Serializable {
    ...
    public Leg(String legId, long startime, long endtime, long duration,
               double length, Position from, Position to, Transport transport,
               LegGeometery legGeometery, List<AlertDelay> alertDelayList,
               List<AlertStrike> alertStrikeList,
               List<AlertParking> alertParkingList, List<AlertRoad> alertRoadList,
               List<AlertAccident> alertAccidentList) {
        super();
        this.legId = legId;
    ...
    public String toString() {
        return "Leg [legId=" + legId + ", startime=" + startime + ", endtime="
                + endtime + ", duration=" + duration + ", length=" + length
                + ", from=" + from + ", to=" + to + ", transport=" + transport
                + ", legGeometery=" + legGeometery + ", alertStrikeList="
                + alertStrikeList + ", alertDelayList=" + alertDelayList
                + ", extra=" + extra + "]";
    }
