...
public final class PointConceptUtil {
	...
	/**
	 * Return max value for given {@link PointConcept} type in a period for a
	 * specific user
	 * 
	 * @param user
	 * @param pointType
	 ...
	 */
	public static Double getScoreMax(Content user, String pointType,
		...
		if (pc != null) {
			...
			if (period != null) {
				for (PeriodInstanceImpl inst : period.getInstances()) {
	 ...
	 * @return
	 */
	public static Double getScoreCurrent(Content user, String pointType,
			String periodIdentifier) {
		PointConcept pc = getPointConcept(user, pointType);
		if (pc != null) {
	...
	/**
	 * Return previous score for a point concept of given type in a period for a
	 * user
	 * 
	 * @param user
	 * @param pointType
	 ...
	 * @return
	 */
	public static Double getScorePrevious(Content user, String pointType,
			String periodIdentifier) {
		PointConcept pc = getPointConcept(user, pointType);
		if (pc != null) {
