...
public class Matcher {
    ...
    public List<PlayerStateDTO> match(List<PlayerStateDTO> users) {
        if (users == null || users.isEmpty()) {
            logger.warn("No users to match");
            return new ArrayList<PlayerStateDTO>();
        }
        List<PlayerStateDTO> result = new ArrayList<PlayerStateDTO>();
    ...
    private boolean pointsMatch(PlayerStateDTO user) {
    ...
    private boolean badgeMatch(PlayerStateDTO user) {
     ...
     */
    /*
    private boolean isUserValidCustomData(PlayerStateDTO user, String criteria) {
